...
* Андрей Зайцев | Github:https://github.com/andrey8606 | Тимлид, кастомная модель User, регистрация и аутентификация пользователей.
* Николай Васильев | Github:https://github.com/SeverInvest | Разработчик, контент Администратора.
* Василий Ковылин | Github:https://github.com/coherentus | Разработчик, контент пользователей.
